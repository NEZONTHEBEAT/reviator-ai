...
@router.get("/{transaction_id}/recovery-actions")
async def get_recovery_actions(
    transaction_id: str,
    db: Session = Depends(get_db),
):
    """
    Get all recovery actions associated with a transaction.
    """
